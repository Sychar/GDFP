...
public class SendEncoder {
    ...
    public static void changeEncoder(String HEXDATA){ //HEXDATA is 10 bytes
        ...
        }else if((UartService.ByteArray[6] & 0xFF) == 153 && (UartService.ByteArray[7] & 0xFF) == 0){ //button_left 0
            //Log.i(TAG,String.valueOf((UartService.ByteArray[8] & 0xF0))); //always 00
            WC_OBJECT.pressVerfahren(); //Verfahren button_left
            //Log.i(TAG,"button5 is called");
        }else if((UartService.ByteArray[6] & 0xFF) == 153 && (UartService.ByteArray[7] & 0xFF) == 1){ //button_left 1
            //Log.i(TAG,String.valueOf((UartService.ByteArray[8] & 0xF0))); //always 00
            WC_OBJECT.pressKennlinie(); //Kennlinie button_left
            //Log.i(TAG,"button6 is called");
        }else if((UartService.ByteArray[6] & 0xFF) == 153 && (UartService.ByteArray[7] & 0xFF) == 2){ //button_left 2
            //Log.i(TAG,String.valueOf((UartService.ByteArray[8] & 0xF0))); //always 00
            WC_OBJECT.pressBetriebsart(); //Betriebsart button_left
            //Log.i(TAG,"button7 is called");
        }else if((UartService.ByteArray[6] & 0xFF) == 153 && (UartService.ByteArray[7] & 0xFF) == 3){ //button_left 3
            //Log.i(TAG,String.valueOf((UartService.ByteArray[8] & 0xF0))); //always 00
            WC_OBJECT.pressMenu(); //Menu button_left
            //Log.i(TAG,"button0 is called");
        }else if((UartService.ByteArray[6] & 0xFF) == 153 && (UartService.ByteArray[7] & 0xFF) == 4){ //button_left 4
            //Log.i(TAG,String.valueOf((UartService.ByteArray[8] & 0xF0))); //always 00
            WC_OBJECT.pressDaten(); //Daten button_left
            //Log.i(TAG,"button4 is called");
        }else if((UartService.ByteArray[6] & 0xFF) == 153 && (UartService.ByteArray[7] & 0xFF) == 5){ //button_left 5
            //Log.i(TAG,String.valueOf((UartService.ByteArray[8] & 0xF0))); //always 00
            WC_OBJECT.pressHome(); //Home button_left
            //Log.i(TAG,"button2 is called");
        }else if((UartService.ByteArray[6] & 0xFF) == 153 && (UartService.ByteArray[7] & 0xFF) == 6){ //button_left 6
            //Log.i(TAG,String.valueOf((UartService.ByteArray[8] & 0xF0))); //always 00
            WC_OBJECT.pressDroessel(); //Droessel button_left
            //Log.i(TAG,"button3 is called");
        }else if((UartService.ByteArray[6] & 0xFF) == 153 && (UartService.ByteArray[7] & 0xFF) == 7){ //button_left 7
            //Log.i(TAG,String.valueOf((UartService.ByteArray[8] & 0xF0))); //always 00
            WC_OBJECT.pressJob(); //Job button_left
            //Log.i(TAG,"button1 is called");
        }else if((UartService.ByteArray[6] & 0xFF) == 153 && (UartService.ByteArray[7] & 0xFF) == 10){ //encoder0 button_left(left)
            //Log.i(TAG,String.valueOf((UartService.ByteArray[8] & 0xF0))); //always 00
            //WC_OBJECT.pressbuttonEncoder0();
            //Log.i(TAG,"encoder0 button_left is pressed");
        }else if((UartService.ByteArray[6] & 0xFF) == 153 && (UartService.ByteArray[7] & 0xFF) == 9){ //encoder1 button_left(middle)
            //Log.i(TAG,String.valueOf((UartService.ByteArray[8] & 0xF0))); //always 00
        ...
        ENCODER_FRAME[7] = 0; //Encoder button_left status
