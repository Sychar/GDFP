...
private static String temp = "";
    ...
    public static void SaveTheJob(){
        ...
        SAVE_JOB[3] = DatenObjekte.JOB_FRAME[10]; //unknown
        ...
        SAVE_JOB[93] =  (byte)(DatenObjekte.JOB_FRAME[10]&0xFF); //unknown
        SAVE_JOB[94] =  (byte)(DatenObjekte.JOB_FRAME[10]>>>8 & 0xFF); //unknown
        SAVE_JOB[95] =  (byte)(DatenObjekte.JOB_FRAME[10]&0xFF); //unknown
        SAVE_JOB[96] =  (byte)(DatenObjekte.JOB_FRAME[10]>>>8 & 0xFF); //unknown
        ...
        SAVE_JOB[117] = (byte)(DatenObjekte.JOB_FRAME[10]&0xFF);//unknown
        SAVE_JOB[118] = (byte)(DatenObjekte.JOB_FRAME[10]>>>8 & 0xFF);//unknown
        SAVE_JOB[119] = (byte)(DatenObjekte.JOB_FRAME[126] & 0xFF); //unknown
        SAVE_JOB[120] = (byte)(DatenObjekte.JOB_FRAME[127] & 0xFF); //unknown
        SAVE_JOB[121] = (byte)(DatenObjekte.JOB_FRAME[128] & 0xFF); //unknown
        SAVE_JOB[122] = (byte)(DatenObjekte.JOB_FRAME[129] & 0xFF); //unknown
        SAVE_JOB[123] = (byte)(DatenObjekte.JOB_FRAME[130] & 0xFF); //unknown
        SAVE_JOB[124] = (byte)(DatenObjekte.JOB_FRAME[131] & 0xFF); //unknown
        SAVE_JOB[125] = (byte)(DatenObjekte.JOB_FRAME[132] & 0xFF); //unknown
        SAVE_JOB[126] = (byte)(DatenObjekte.JOB_FRAME[133] & 0xFF); //unknown
        SAVE_JOB[127] = (byte)(DatenObjekte.JOB_FRAME[134] & 0xFF); //unknown
        SAVE_JOB[128] = (byte)(DatenObjekte.JOB_FRAME[135] & 0xFF); //unknown
        SAVE_JOB[129] = (byte)(DatenObjekte.JOB_FRAME[136] & 0xFF); //unknown
        SAVE_JOB[130] = (byte)(DatenObjekte.JOB_FRAME[137] & 0xFF); //unknown
    ...
    public static void secondJobSend(int JOB_NUM){
        ...
        secondframe[9] = 2;
        /*secondframe[10] = DatenObjekte.JOB_FRAME[8];
        secondframe[11] = DatenObjekte.JOB_FRAME[9];
        secondframe[12] = DatenObjekte.JOB_FRAME[10];
        secondframe[13] = DatenObjekte.JOB_FRAME[11];*/
        ...
        for (int k = 0; k < 36; k++) { //send 36 frames to the machine
            ...
            /*secondframe[increment+6] = DatenObjekte.JOB_FRAME[num];
            secondframe[increment+7] = DatenObjekte.JOB_FRAME[num + 1];
            secondframe[increment+8] = DatenObjekte.JOB_FRAME[num + 2];
            secondframe[increment+9] = DatenObjekte.JOB_FRAME[num + 3];
            secondframe[increment+10] = DatenObjekte.JOB_FRAME[num + 4];
            secondframe[increment+11] = DatenObjekte.JOB_FRAME[num + 5];
            secondframe[increment+12] = DatenObjekte.JOB_FRAME[num + 6];
            secondframe[increment+13] = DatenObjekte.JOB_FRAME[num + 7];*/
        ...
        for(int i=0; i<294; i++){ //store data bytes
            //jobupdate1[i] = DatenObjekte.JOB_FRAME[i + 8];
        ...
        /*secondframe[709] = DatenObjekte.JOB_FRAME[300];
        secondframe[710] = DatenObjekte.JOB_FRAME[301];*/
